...
export const CourseAssignmentDataTable = ({ columns, data }) => {
  ...
  // title , faculty , course , duedate
  return (
    <div className="min-w-max max-w-7xl mt-2">
      <DataTableToolbar table={table} className="my-4" />
    ...
    <div className="flex gap-2">
      <div className="flex items-center">
        <Input
          ...
          value={table.getColumn("class")?.getFilterValue() ?? ""}
          onChange={(event) =>
